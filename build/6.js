...
var UserSettingsRefillKeysPage = /** @class */ (function () {
    ...
    UserSettingsRefillKeysPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-user-settings-refill-keys',template:/*ion-inline-start:"D:\ger\wzk\front\3 wzk few options3\3 wzk few options\clinic_app_frontend\src\pages\user-settings-refill-keys\user-settings-refill-keys.html"*/'<!--\n  Generated template for the UserSettingsRefillKeysPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Refilling keys</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-card>\n    <ion-card-header>\n      <ion-card-title>\n        Refilling keys\n      </ion-card-title>\n    </ion-card-header>\n    <ion-card-content>\n      <p>You can connect the flash drive that is provided at the hospital in order to refill the encryption key of the application</p>\n      <button ion-button block color="primary" (click)="refillKeys()" >Refill keys</button>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n'/*ion-inline-end:"D:\ger\wzk\front\3 wzk few options3\3 wzk few options\clinic_app_frontend\src\pages\user-settings-refill-keys\user-settings-refill-keys.html"*/,
        }),

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__info_item__ = __webpack_require__(757);
...
var InfoItemPage = /** @class */ (function () {
    ...
    InfoItemPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-info-item',template:/*ion-inline-start:"D:\ger\wzk\front\3 wzk few options3\3 wzk few options\clinic_app_frontend\src\pages\info-item\info-item.html"*/'<!--\n  Generated template for the InfoItemPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{post.title}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-card>\n    <img *ngIf="!!post.image" src="{{post.image}}"/>\n\n    <ion-card-content padding>\n      <ion-card-title>\n        {{post.title}}\n      </ion-card-title>\n      <!-- <h2 class="card-title">{{post.title}}</h2> -->\n      <div [innerHTML]="safeHtml"></div>\n      <p><i>{{post.tags}}</i></p>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n'/*ion-inline-end:"D:\ger\wzk\front\3 wzk few options3\3 wzk few options\clinic_app_frontend\src\pages\info-item\info-item.html"*/,
        }),
